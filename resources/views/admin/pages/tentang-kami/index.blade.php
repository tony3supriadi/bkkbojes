...
<form id="bulk-destroy" action="{{ route('admin.tentang-kami.bulk-destroy') }}" method="post" class="d-none">
    @csrf
    @method('delete')
...
<script type=text/javascript>
    $(document).ready(function(){
        ...
        $('.datatable').DataTable({
            ...
            ajax: {
                url: '/app/v1/bkk-admin/tentang-kami?type=json',
                dataSrc: (data) => {
                    return data;
                }
            },
...
<script type="text/javascript">
    $(document).ready(function() {
        Swal.fire({
            icon: 'success',
            title: 'Berhasil',
            text: 'Proses hapus data tentang kami berhasil.',
