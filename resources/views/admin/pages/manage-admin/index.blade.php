...
<form id="bulk-destroy" action="{{ route('admin.manage-admin.bulk-destroy') }}" method="post" class="d-none">
    @csrf
    @method('delete')
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.datatable').DataTable({
            ...
            ajax: {
                url: '/app/v1/bkk-admin/manage-admin?type=json',
                dataSrc: (data) => {
                    return data;
                }
            },
            ...
            rowCallback: (row, data, index) => {
                ...
                $('td', row).on('dblclick', () => {
                    window.location.href = "/app/v1/bkk-admin/manage-admin/" + data.encryptid + "/edit";
                });
            }
        });
        ...
        $('.btn-bulk-destroy').on('click', () => {
            Swal.fire({
                ...
                $('#bulk-destroy input[name="admins"]').val(JSON.stringify(selected));
                $('#bulk-destroy').submit();
            });
        });
    });
