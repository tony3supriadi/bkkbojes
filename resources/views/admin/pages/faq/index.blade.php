...
<form id="bulk-destroy" action="{{ route('admin.faq.bulk-destroy') }}" method="post" class="d-none">
    @csrf
    @method('delete')
        ...
        $('.datatable').DataTable({
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    return (row.order ? row.order : '00') + '. ' + row.title;
                }
            }, {
                defaultContent: '',
                title: '',
                ...
                render: (data, type, row, meta) => {
                    return `
                        <a href="/app/v1/bkk-admin/faq/${row.encryptid}/edit" class="mx-1 text-primary text-decoration-none">
                            <i class="fa fa-edit"></i>
                        </a>

                        <a href="#" onclick="deleted('/app/v1/bkk-admin/faq/${row.encryptid}')" class="mx-1 text-danger text-decoration-none">
...
<script type="text/javascript">
    $(document).ready(function() {
        Swal.fire({
            icon: 'success',
            title: 'Berhasil',
            text: 'Proses hapus data FAQ berhasil.',
