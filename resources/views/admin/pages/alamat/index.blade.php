...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Alamat</h1>
    ...
    <div class="button-action">
        ...
        <a href="{{ route('admin.alamat.create') }}" class="btn btn-primary shadow-sm">
...
<form id="bulk-destroy" action="{{ route('admin.alamat.bulk-destroy') }}" method="post" class="d-none">
    @csrf
    @method('delete')
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.datatable').DataTable({
            ...
            ajax: {
                url: '/app/v1/bkk-admin/alamat?type=json',
                dataSrc: (data) => {
                    return data;
                }
            },
            ...
            rowCallback: (row, data, index) => {
                ...
                $('td', row).on('dblclick', () => {
                    window.location.href = "/app/v1/bkk-admin/alamat/" + data.encryptid + "/edit";
                });
            }
        });
        ...
        $('.btn-bulk-destroy').on('click', () => {
            Swal.fire({
                ...
                $('#bulk-destroy input[name="address"]').val(JSON.stringify(selected));
                $('#bulk-destroy').submit();
            });
        });
    });
...
<script type="text/javascript">
    $(document).ready(function() {
        Swal.fire({
            icon: 'success',
            title: 'Berhasil',
            text: 'Proses hapus data alamat berhasil.',
