        ...
        <form action="{{ route('akun.profile.pengalaman.store') }}" method="post" class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai') }}" class="form-control @error('tanggal_selesai') is-invalid border-danger @enderror" @if(old('masih_bekerja')) readonly @endif>
            ...
            <div class="col-md-9">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="bidang_usaha" id="bidang_usaha" value="{{ old('bidang_usaha') }}" class="form-control @error('bidang_usaha') is-invalid border-danger @enderror">
                    @error('bidang_usaha')
                    <div class="invalid-feedback">{{ ucfirst($message) }}</div>
                    @enderror
                </div>
